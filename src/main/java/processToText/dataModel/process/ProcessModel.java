...
import processToText.contentDetermination.labelAnalysis.EnglishLabelCategorizer;
...
import processToText.contentDetermination.labelAnalysis.EnglishLabelProperties;
...
//		System.out.println(activities.size() + "\t" + events.size() + "\t" + gateways.size());
        ...
        ArrayList<processToText.contentDetermination.labelAnalysis.structure.Activity> modela = new ArrayList<processToText.contentDetermination.labelAnalysis.structure.Activity>();
        ...
        for (Activity a : activities.values()) {
            ...
            try {
                ...
                processToText.contentDetermination.labelAnalysis.structure.Activity act = new processToText.contentDetermination.labelAnalysis.structure.Activity(label, label, "", modela);
