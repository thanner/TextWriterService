...
import processToText.contentDetermination.labelAnalysis.interfaces.LabelDeriver;
...
//		System.out.println("A: " + props.getAction() + " - BO: " + props.getBusinessObject() + " - ADD: " + props.getAdditionalInfo());
    ...
    private boolean checkForPhrasalVerb(String word) throws JWNLException {
        ...
        if (indexWord != null) {
            return Arrays.asList(EnglishLabelProperties.elements).contains(word.split(" ")[1]) != true;
        } else {
            return false;
        }
    }
