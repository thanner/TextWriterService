...
public interface IDirectedHyperEdge<V extends IVertex> extends IHyperEdge<V> {
     ...
     */
    Collection<V> addSourceVertices(Collection<V> vs);
     ...
     */
    Collection<V> addTargetVertices(Collection<V> vs);
     ...
     */
    Collection<V> removeSourceVertices(Collection<V> vs);
     ...
     */
    Collection<V> removeTargetVertices(Collection<V> vs);
     ...
     */
    Collection<V> getOtherSourceVertices(Collection<V> vs);
     ...
     * @return Other target vertices as 'v'
     */
    Collection<V> getOtherTargetVertices(Collection<V> vs);
