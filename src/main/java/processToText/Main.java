...
import processToText.dataModel.jsonReader.JSONReader;
import processToText.dataModel.jsonStructure.Doc;
...
public class Main {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String file = "src/main/java/processToText/BicycleManufacturing.json";
