package processToText.contentDetermination.labelAnalysis;
...
import processToText.contentDetermination.support.Distance;
import processToText.contentDetermination.support.Noun2VerbTransformer;
import processToText.contentDetermination.support.Stemmer;
...
//	}
     ...
     */
    public String getAdverb(String adj) {
        String adv = "";
    ...
    public boolean hasPluralNounAtEnd(String label, String[] labelSplit) throws JWNLException {
        ...
        if (label.endsWith("s")) {
            ...
            return labelSplit[labelSplit.length - 1].equals(singular) == false;
        } else {
            return false;
        }
    }
    ...
    public boolean isDescriptiveLabel(String labelTag) {
        ...
        if (labelTag.contains("VBZ")) {
            return isVerb(splitLabel[0]) == false || isInfinitive(getInfinitiveOfAction(splitLabel[0]), splitLabel[0]) == false;
        }
        return false;
    }
     ...
     * @throws Exception
     */
    public void transformActions(String label, String[] labelSplit, EnglishLabelProperties props) {
