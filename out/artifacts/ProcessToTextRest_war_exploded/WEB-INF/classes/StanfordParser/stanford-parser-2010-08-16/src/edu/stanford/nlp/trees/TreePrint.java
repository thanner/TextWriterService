...
public class TreePrint {
   ...
   *  Dan Bikel's WordNetWrapper code is thread safe, but it definitely doesn't
...
//            System.err.println(childIndex+"\t"+parentIndex);
   ...
   *  WordNetWrapper and are contiguous in the tree into a single node.
  ...
  private static synchronized Tree getCollocationProcessedTree(Tree tree,
    ...
    if (wnc == null) {
      try {
        ...
        System.err.println("Couldn't open WordNetWrapper Connection.  Aborting collocation detection.");
        e.printStackTrace();
        wnc = null;
      }
    }
