...
/**
 * Finds WordNetWrapper collocations in parse trees.  It can restructure
...
/**
 * Traverses the parse tree to find WordNetWrapper collocations.
 */
  ...
  /**
   * Checks to see if WordNetWrapper contains the given word in its lexicon.
   * @param s Token
   * @return If the given token is in WordNetWrapper.
   */
